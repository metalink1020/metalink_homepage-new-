...
export const metadata: Metadata = {
  ...
  description:
    "메타링크 대표이사 연정욱의 CEO 인사말. 기술과 사람, 비즈니스와 미래를 잇는 IT·마케팅 파트너 메타링크를 소개합니다.",
};

const PARAGRAPHS = [
  "안녕하십니까, 주식회사 메타링크 대표이사 연정욱입니다.",
  "메타링크는 기술과 사람을 잇는 AI·IT·마케팅 전문기업입니다. 우리는 시스템을 만드는 회사가 아니라, 기술을 통해 사람의 일과 기업의 성과를 변화시키는 파트너를 지향합니다. 최신 기술을 앞세우기보다 왜 필요한지, 누구를 위한 기술인지를 먼저 묻고, 사람이 실제로 체감하는 변화를 기술의 기준으로 삼습니다.",
  ...
  "기술은 계속 진화하지만, 그 기술을 사용하는 주체는 언제나 사람입니다. 메타링크는 기술과 사람, 비즈니스와 미래를 잇는 AI·IT·마케팅 파트너로서 고객의 성장에 끝까지 함께하겠습니다.",
  "감사합니다.",
];
...
export default function CeoPage() {
  return (
    <>
      <SubPageHero
        title="CEO Message"
        description="기술과 사람, 비즈니스와 미래를 잇는 IT·마케팅 파트너 메타링크입니다."
